...
$ACCESS_PWD='WoRlD@135$'; #!!!IMPORTANT!!! this is script access password, SET IT if you want to protect you DB from public access

#DEFAULT db connection settings
# --- WARNING! --- if you set defaults - it's recommended to set $ACCESS_PWD to protect your db!
$DBDEF=array(
'user'=>"rySJain",#required
'pwd'=>"AVNS_20OT1DsWru_K0aB9sld", #required
'db'=>"rySJain",  #optional, default DB
'host'=>"db-mysql-blr1-69796-do-user-15741346-0.c.db.ondigitalocean.com",#optional
