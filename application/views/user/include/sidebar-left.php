                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block user-dropdown">
                            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                                ...
                                <span class="d-none d-xl-inline-block ms-1">
								  <?php 
									  ...
									  $udata = $this->db->where('aid',$uid)->get('administrator')->row_array();
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
								...
								-->
                                <a class="dropdown-item" href="<?php echo site_url(); ?>"><i class="ri-wallet-2-line align-middle me-1"></i>Home</a>
                                <a class="dropdown-item" href="<?php echo site_url('account-delete'); ?>"><i class="ri-wallet-2-line align-middle me-1"></i>Delete account</a>
                                <a class="dropdown-item text-danger" href="<?php echo BASE_HTTP_REL_URL; ?>logout"><i class="ri-shut-down-line align-middle me-1 text-danger"></i> Logout</a>
                            </div>
                        </div>
