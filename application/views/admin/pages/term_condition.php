                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Manage Term Condition</a></li>
                    ...
                    <div class="card-body">
                        <form id="createForm1" enctype="multipart/form-data" onsubmit="return dorequest('<?php echo site_url('administrator/Pages/managePages'); ?>','#createForm1','#successMsg')">
                            <input type="hidden" name="page_id" value="<?php echo !empty($get_one_plan['page_id'])?$get_one_plan['page_id']:''; ?>">
                             <input type="hidden" name="name" value="term_condition">
							<div class="row">
                                <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <div style='float: right; margin-bottom: 10px;'>
                            <a class="btn btn-success" href="<?php echo site_url('administrator/pages/terms-condition/add'); ?>" style="background-color:#0bb197;">Add New</a>
                        </div>
                        <div style='clear:both;'></div>
                        <table id="tabeldatahere" class="table table-striped">
                            ...
                            <tbody class="text-center">
                                ...
                                <tr>
									...
									<td><a href="<?php echo site_url('administrator/pages/terms-condition/').$row['page_id']; ?>"><i class="fa-solid fa-pen-to-square"></i></a></td>
                                </tr>
                                <?php
								 }
								}
