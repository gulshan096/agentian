					...
					<div class="page-title-right">
						<ol class="breadcrumb m-0">
							<li class="breadcrumb-item active">
								<a href="javascript: void(0);">Sell Property</a>
							</li>
						...
						<div class="card collapse" id="collapseExample">
							<div class="card-body">
									<div class="row " >
										...
										<div class="col-md-3">
											<div class="form-group mb-3">
												<input id="scid" type="hidden" value="<?php  echo isset($getOneProperty['property_type'])?$getOneProperty['property_type']:''; ?>">
						...
						<div class="card collapse" id="collapseExample2">
							<div class="card-body">
								<div class="row " >
									...
									<div class="col-md-3">
										<div class="form-group mb-3">
											<input type="hidden" value="<?php  echo isset($getOneProperty['property_city'])?$getOneProperty['property_city']:''; ?>" id="pc">
...
if(isset($getOneProperty['rera_approved']) && $getOneProperty['rera_approved'] === "1")
{
  ?>
    
    <script> $("#rap").trigger("change"); </script>
  <?php
}
		...
		$(document).ready(function(){
			...
			var tr = '<tr class="text-center">'+
					...
					'<td class="" colspan=""><label for="doc_'+index+'"><i class="fa fa-plus ms" "></i></label></td>'+
						'<td style="display:none; visibility:none;" class="target" colspan=""><input  type="file" id="doc_'+index+'" class="form-control " name="property_image[]" onchange="getImage(this.value,'+index+');"></td>'+
