                ...
                <div class="card">
                    <div class="card-body">
                        <div style='float: right; margin-bottom: 10px;'>
                            <a class="btn btn-success" href="<?php echo site_url('administrator/location/state/add'); ?>" style="background-color:#0bb197;">Add New</a>
                        </div>
                        <div style='clear:both;'></div>
                        <table id="tabeldatahere" class="table table-striped">
                            ...
                            <tbody class="text-center">
                                ...
                                <tr>
                                    <td><?php echo $i; ?></td>
                                    <td><?php echo !empty($state['name'])?$state['name']:''; ?></td>
                                    <td><?php echo !empty($state['country_code'])?$state['country_code']:''; ?></td>
<td><?php echo !empty($state['status'])?"<button onclick='updatestatus(this);' t='loc_states' i='id' v='$state[id]' s='1' type='button' class='btn btn-success'>Active</button>":"<button onclick='updatestatus(this);' t='loc_states' i='id' v='$state[id]' s='0' type='button' class='btn btn-danger'>Inactive</button>"; ?></td>
                                    <td><a class="fa fa-edit" href="<?php echo site_url('administrator/location/state').$state['id']; ?>"></a></td>
                                </tr>
                                <?php
								 }
								}
