                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Buy Property Request</a></li>
                ...
                <div class="card">
                    <div class="card-body">
                        <div style='float: right; margin-bottom: 10px;'>
                            <a class="btn btn-success" href="<?php echo base_url('administrator/property/buy-property/add') ?>" style="background-color:#0bb197;">Add New</a>
                        </div>
                        ...
                        <table id="tabeldatahere" class="table table-striped">
                            ...
                            <tbody class="text-center">
                                ...
                                <tr>
                                    ...
                                    <td><a href="<?php echo site_url('administrator/property/buy-property/').$row['property_id']; ?>"><i class="fa-solid fa-pen-to-square"></i></a></td>
                                </tr>
                                <?php
								 }
								}
