        ...
        <div id="main-wrapper">
            ...
            <div id="app">
                <div class="page-title">
                   <div class="container text-center"><h4 class="text-white">Proerty For Sell</h4></div>
                </div>
                <!-- ============================ All Property ================================== -->
                <section class="gray">
                    <div class="container">
                                        ...
                                        <div class="item-sorting-box">
                                            <div class="item-sorting clearfix">
                                                <div class="left-column pull-left">
                                                    <h4 class="m-0">
                                                    <a href="<?php  echo base_url('post_property') ?>" class="text-success" >Go Back</a><span class="px-2" ><i class="fa fa-angle-double-right " aria-hidden="true"></i></span> <span style="color : #2540A2;" >Sell</span>
                                                    </h4>
                                                </div>
                                            </div>
                                        </div>
