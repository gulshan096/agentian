			...
			<div id="main-wrapper">
				...
				<div id="app">
					<div class="page-title">
					   <div class="container text-center"><h4 class="text-white">Proerty For Rent</h4></div>
					</div>
					<!-- ============================ All Property ================================== -->
					<section class="gray">
						<div class="container">
							<div class="row">
								<div class="col-lg-12 col-md-12 list-layout">
											...
											<div class="item-sorting-box">
												<div class="item-sorting clearfix">
													<div class="left-column pull-left">
														<h4 class="m-0">
														<a href="<?php  echo base_url('post_property') ?>" class="text-success" >Go Back</a><span class="px-2" ><i class="fa fa-angle-double-right " aria-hidden="true"></i></span> <span style="color : #2540A2;" >Rent In</span>
														</h4>
													</div>
												</div>
											</div>
									...
									<form id="createForm1"  onsubmit="return dorequest('<?php  echo site_url('user/property/manageproperty'); ?>','#createForm1','#successMsg')" enctype="multipart/form-data">
										<input type="hidden" name="request_from" value="5">
