        ...
        <div id="main-wrapper">
            ...
            <div id="app">
                <div class="page-title">
                   <div class="container text-center"><h4 class="text-white">Proerty For Rent Out</h4></div>
                </div>
                <!-- ============================ All Property ================================== -->
                <section class="gray">
                    <div class="container">
                                        ...
                                        <div class="item-sorting-box">
                                            <div class="item-sorting clearfix">
                                                <div class="left-column pull-left">
                                                    <h4 class="m-0">
                                                    <a href="<?php  echo base_url('post_property') ?>" class="text-success" >Go Back</a><span class="px-2" ><i class="fa fa-angle-double-right " aria-hidden="true"></i></span> <span style="color : #2540A2;" >Rent Out</span>
                                                    </h4>
                                                </div>
                                            </div>
                                        </div>
										...
										<div class="col-xl-12" >
											<div class="addform" id="addPost">
												<form id="createForm1" enctype="multipart/form-data" onsubmit="return dorequest('<?php echo !empty($getOneProperty)?site_url('user/property/updateproperty'):site_url('user/property/manageproperty'); ?>','#createForm1','#successMsg')">
													...
													<input type="hidden" name="request_from" value="3">
															...
															<div class="col-md-3">
																...
																<div class="col-md-3">
																	<div class="form-group mb-3">
																		...
																		<input required value="<?php echo !empty($propertyAddress['map_location'])?$propertyAddress['map_location']:''; ?>" name="map_location"   type="text" class="form-control mx-1"  required />
																	</div>
																</div>
																<div class="col-md-3">
																	<div class="form-group mb-3">
																...
																<div class="col-md-3">
																	<div class="form-group mb-3">
																		...
																		<input required value="<?php echo !empty($getOneProperty['property_address1'])?$getOneProperty['property_address1']:''; ?>" name="property_address1" type="text" class="form-control" />
																	</div>
																</div>
