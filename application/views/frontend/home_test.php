		...
		<div id="main-wrapper">
			...
			<div id="app">
				<div id="ismain-homes">
					...
					<div>
					<div class="image-cover hero-banner " style="background:url(<?php echo base_url().$banner['banner_img']; ?>) no-repeat;">
						<div class="container">
						    <form  method="post" id="frmhomesearch" action="<?php echo site_url('search/property'); ?>" >
							<div class="hero-search-wrap-d">
									<div class="hero-search-content side-form">
										<div class="row">
											...
											<div class="col-lg-6 col-md-6 col-sm-6">
												<div class="form-group" id="lf">
												  <div class="wrapper" >
												     <input type="radio"   name="request_from" value="1" id="option-3">
										...
										<div class="row" style="margin  : 0 2px" >
											...
											<div class="col-lg-6 col-md-6 col-sm-6">
												<div class="form-group">
													<input type="search" class="form-control inLabel" name="key-word" placeholder = "Search here" >
												</div>
											</div>
											<div class="col-lg-3 col-md-6 col-sm-6">
												<div class="form-group">
										 ...
										 <div class="row collapse" id="collapseExample" style="margin : 0 2px" >
										 	...
										 	<div class="col-lg-2 col-md-2 col-sm-2">
												<div class="form-group">
													...
													<select id="property_cat"  name="category_type" class="form-control has-sub-category inLabel">
										 ...
										 <div class="col-lg-2 col-md-2 col-sm-2">
											...
											<div class="col-lg-2 col-md-2 col-sm-2">
												<div class="form-group">
													...
													<input  onkeyup="value=value.replace(/[^\d]/g,'')" type="text" name="min_budget" style="height:47px !important" class="number form-control inLabel">
												</div>
											</div>
											<div class="col-lg-2 col-md-2 col-sm-2">
												<div class="form-group">
													<label>Max Price</label>
													<input onkeyup="value=value.replace(/[^\d]/g,'')" type="text" name="max_budget" style="height:47px !important" class="number form-control inLabel">
												</div>
											</div>
										</div>
									</div>
									...
									<div class="hero-search-content side-form">
										...
										<div class="row">
										    <div class="col-lg-12 col-md-12 col-sm-12">
												<div class="form-group">
												  <div class="wrapper ">
												     <input type="radio"   name="sell_type" value="73" id="option-9m">
													 <label for="option-9m" class="option option-9m">Residential</label>
													 <input type="radio"   name="sell_type" value="74" id="option-10m" >
													 <label for="option-10m" class="option option-10m">Commercial</label> 
												  </div>
												</div>
											</div>
											<div class="col-lg-12 col-md-12 col-sm-12">
												<div class="form-group">
													<label>Property Type</label>
													<select id="property_type"  name="property_type" class="form-control has-sub-category">
														<option value="">&nbsp;</option>
														<option>Select</option>
													</select>
												</div>
										...
										<div class="row">
											...
											<div class="col-lg-6 col-md-6 col-sm-6">
												<div class="form-group">
													<label>City</label>
													<select class="form-control city_id" name="property_city" id="cid" >
													  <option></option>
													</select>
												</div>
											</div>
														   ...
														   <?php  
														     if(count($fp['propertyImages']) > 0)
															 {
																 foreach($fp['propertyImages'] as $pimg)
																 {
																	 ?>
																	    <div>
																			<a href="<?php echo base_url("property_details?property_id=").$fp['property_id']; ?>">
													...
													<div class="listing-short-detail-wrap">
														<div class="listing-short-detail">
															<div class="list-price d-flex justify-content-between">
																...
																<i class="fa fa-inr text-dark"></i> <?php echo $fp['max_budget']; ?>
																</h6>
															</div>
															<h4 class="listing-name">
															<a class="prt-link-detail"
															title="4113 Holiday Drive" href="<?php echo base_url("property_details?property_id=").$fp['property_id']; ?>">	
												...
												<div class="listing-detail-footer">
													...
													<a href="<?php echo base_url("property_details?property_id=").$fp['property_id']; ?>">
														<div class="foot-location d-flex">
															<img src="assets/themes/resido/img/pin.svg" width="18"
													...
													<div class="footer-flex">
														<a href="<?php echo base_url("property_details?property_id=").$fp['property_id']; ?>" class="prt-view">View</a>
													</div>
												</div>
											</div>
										...
										<div class="single-items">
											<div class="property-listing property-2 shadow-none border"
															...
															<?php  
														     if(count($plf['propertyImages']) > 0)
															 {
																 foreach($plf['propertyImages'] as $pimg)
																 {
																	 ?>
																	    <div>
																			<a href="<?php echo base_url("property_details?property_id=").$plf['property_id']; ?>">
																				<img src="assets/storage/general/img-loading.jpg"
																				data-src="<?php echo base_url().$pimg['property_image']; ?>"
																				class="img-fluid mx-auto lazy" alt="4113 Holiday Drive"/>
																			</a>
												...
												<div class="listing-detail-wrapper">
													<div class="listing-short-detail-wrap">
														<div class="listing-short-detail">
														<a class="prt-link-detail" href="<?php echo base_url("property_details?property_id=").$plf['property_id']; ?>">
															<div class="list-price d-flex justify-content-between">
																<span>
																	<span class="prt-types rent"><?php echo $plf['building_name']; ?></span>
																</span>
																<h6 class="listing-card-info-price">
																 <i class="fa fa-inr text-dark"></i><?php echo $plf['max_budget']; ?>
																</h6>
															</div>
															</a>
															<h4 class="listing-name">
												...
												<div class="listing-detail-footer">
													...
													<div class="footer-flex">
														<a href="<?php echo base_url("property_details?property_id=").$plf['property_id']; ?>" class="prt-view">View</a>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="single-items">
											<div class="property-listing property-2 shadow-none border"
															...
															<?php  
														     if(count($paf['propertyImages']) > 0)
															 {
																 foreach($paf['propertyImages'] as $pimg)
																 {
																	 ?>
																	    <div>
																			<a href="<?php echo base_url("property_details?property_id=").$paf['property_id']; ?>">
																				<img src="assets/storage/general/img-loading.jpg"
																				data-src="<?php echo base_url().$pimg['property_image']; ?>"
																				class="img-fluid mx-auto lazy" alt="4113 Holiday Drive"/>
																			</a>
													...
													<div class="listing-short-detail-wrap">
														<div class="listing-short-detail">
															...
															<div class="list-price d-flex justify-content-between">
																...
																<h6 class="listing-card-info-price">
																<i class="fa fa-inr text-dark"></i> <?php echo $paf['max_budget']; ?>
																</h6>
															</div>
															</a>
															<h4 class="listing-name">
												...
												<div class="listing-detail-footer">
													...
													<div class="footer-flex">
														<a href="<?php echo base_url("property_details?property_id=").$paf['property_id']; ?>" class="prt-view">View</a>
													</div>
												</div>
											</div>
										</div>
